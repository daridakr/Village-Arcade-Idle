...
public class BasicAttackConfig : Skill
{
	...
	public override bool CanAICast(ICaster caster)
	{
        return Vector3.Distance(caster.Transform.position, _target.transform.position) <= caster.StatsHandler.GetStat<Stat>(StatID._Range).GetValue(Range);
    }
}
