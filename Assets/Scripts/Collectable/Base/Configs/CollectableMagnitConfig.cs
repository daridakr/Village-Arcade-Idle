...
namespace Village
{
    [CreateAssetMenu(fileName = "CollectableMagnitConfig", menuName = "Gameplay/Collectable Magnit Config")]
    public sealed class CollectableMagnitConfig : ScriptableObject
    {
