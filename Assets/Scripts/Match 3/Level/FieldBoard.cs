...
//            yield return new WaitForEndOfFrame();
         ...
         public void ChangeFoundCombines(List<List<Items.Item>> allFoundCombines)
         {
         ...
         public List<Items.Item.Waypoint> GetWaypoints(Square startSquare, Square destSquare, List<Square> list = null)
         {
             if (destSquare.Equals(startSquare) || startSquare == null)
                 return list.Select(i => new Items.Item.Waypoint(i.transform.position, i)).ToList();
         ...
         public void DestroyItemsAround(Square square, Items.Item item1)
         {
         ...
         public List<List<Items.Item>> GetMatches(FindSeparating separating = FindSeparating.NONE, int matches = 3)
         {
             var newCombines = new List<List<Items.Item>>();
         ...
         public List<Items.Item> GetRandomItems(int count)
         {
             var list = GetItems(true);

             var list2 = new List<Items.Item>();
         ...
         /// <returns></returns>
         public List<Items.Item> GetItems(bool onlySimple = false, Items.Item[] exceptItems = null, bool nonDestroying = true)
         {
             if (exceptItems == null) exceptItems = new Items.Item[] { };
         ...
         /// </summary>
         /// <returns></returns>
         public List<Items.Item> GetJustCreatedItems()
         {
             return FindObjectsOfType<Items.Item>().Where(i => i.JustCreatedItem && i.needFall && !i.falling && !i.GetItemInterfaces()[0].IsStaticOnStart()).ToList();
         }
         ...
         /// </summary>
         /// <returns></returns>
         public List<Items.Item> GetItemsFromBottomOrder()
         {
         ...
         /// </summary>
         /// <returns></returns>
         public List<Items.Item> GetAllExtaItems()
         {
         ...
         /// <returns></returns>
         public Items.Item[] GetItemsByColor(int color)
         {
         ...
         /// </summary>
         /// <returns></returns>
         public Items.Item[] GetLonelyItemsOrCage()
         {
