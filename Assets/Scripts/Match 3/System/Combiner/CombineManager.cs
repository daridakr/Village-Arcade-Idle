...
namespace SweetSugar.Scripts.System.Combiner
{
    ...
    public class CombineManager
    {
        ...
        Dictionary<Items.Item, Combine> dic = new Dictionary<Items.Item, Combine>();
        Dictionary<Items.Item, Combine> dicPredict = new Dictionary<Items.Item, Combine>();
        ...
        public List<List<Items.Item>> GetCombinedItems(FieldBoard field, bool setNextItemType = false)
        {
            var combinedItems = new List<List<Items.Item>>();
        ...
        public List<Combine> CheckCombines(Dictionary<Items.Item, Combine> d, List<Combine> foundCombines)
        {
        ...
        void CheckMatches(Items.Item item, int color, ref Combine combine)
        {
        ...
        void AddItemToCombine(Combine combine, Items.Item item, Dictionary<Items.Item, Combine> d, List<Combine> lCombines)
        {
        ...
        Combine FindCombine(Items.Item item)
        {
        ...
        Combine FindCombineInDic(Items.Item item, Dictionary<Items.Item, Combine> d)
        {
            Combine combine;
        ...
        bool CheckColor(Items.Item item, Items.Item nextItem)
        {
    ...
    public class Combine
    {
        ...
        public Items.Item triggerItem;
        public Vector2 dir;
        public Items.Item mainSearchItem;

        public Items.Item AddingItem
        {
            get
            {
                return addingItem;
        ...
        bool CompareRows(Items.Item item)
        {
            if (items.Count > 0)
            {
        ...
        bool CompareColumns(Items.Item item)
        {
            if (items.Count > 0)
            {
        ...
        Items.Item PreviousItem()
        {
            return items[items.Count - 1];
        }

        public Combine ConvertToCombine(List<Items.Item> list)
        {
