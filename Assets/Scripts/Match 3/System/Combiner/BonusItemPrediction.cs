...
namespace SweetSugar.Scripts.System.Combiner
{
    ...
    public class BonusItemPrediction
    {
        ...
        public static List<Items.Item> IsItemPredicted(ItemsTypes itemType)
        {
            Debug.Log("prediction bonus..");
            List<Items.Item> predicted;
        ...
        private static List<Items.Item> PridictCombines(FieldBoard field, bool right, ItemsTypes itemType)
        {
