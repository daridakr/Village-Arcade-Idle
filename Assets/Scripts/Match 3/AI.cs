...
namespace SweetSugar.Scripts
{
    ...
    public class AI : MonoBehaviour
    {
        ...
        /// The tip items
        /// </summary>
        private List<Items.Item> currentPreCombine = new List<Items.Item>();
        ...
        bool CheckSquare(Square square, int COLOR, bool moveThis = false)
        {
            if (square == null)
                return false;
            if(currentPreCombine==null) currentPreCombine= new List<Items.Item>();
            if (square.Item != null)
            {
        ...
        public List<Items.Item> GetCombine()
        {
        ...
        public IEnumerator CheckPossibleCombines()
        {
            ...
            {
                currentPreCombine = new List<Items.Item>();
        ...
        void showTip(List<Items.Item> nextMoveItems)
        {
        ...
        //show tip coroutine
        IEnumerator showTipCor(List<Items.Item> nextMoveItems)
        {
            changeTipAI = false;
            gotTip = true;
            corCount++;
            ...
            for (var COLOR = 0; COLOR < 6; COLOR++)
            {
                for (var col = 0; col < LevelManager.THIS.levelData.maxCols; col++)
                {
                    for (var row = 0; row < LevelManager.THIS.levelData.maxRows; row++)
                    {
                        ...
                        {
                            var l = new Items.Item[currentPreCombine.Count];
