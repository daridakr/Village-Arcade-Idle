...
{
    public static List<SweetSugar.Scripts.Items.Item> items = new List<SweetSugar.Scripts.Items.Item>();
    ...
    private int SortByDistance(SweetSugar.Scripts.Items.Item item1, SweetSugar.Scripts.Items.Item item2)
    {
    ...
    public int FindMaxY(List<SweetSugar.Scripts.Items.Item> list)
    {
