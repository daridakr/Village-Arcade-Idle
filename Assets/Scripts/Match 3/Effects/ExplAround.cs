...
namespace SweetSugar.Scripts.Effects
{
    ...
    public class ExplAround : MonoBehaviour
    {
        ...
        public Items.Item[] itemsSecondCirle;
        public Items.Item[] itemsThirdCircle;
        public float duration = 1.2f;
        public AnimationCurve curve;
        public GameObject particle;
        public float startParticle = 0.25f;
        public AudioSource AudioSource;
        private void Play(Items.Item[] array, float delay, float force)
        {
            foreach (Items.Item item1 in array)
            {
        ...
        {
            Items.Item _item = ((GameObject) o).transform.parent.GetComponent<Items.Item>();
...
//            item.SetActive(false);
        ...
        private List<Items.Item> GetItemsAround8(Square square)
        {
            var col = square.col;
            var row = square.row;
        ...
        private List<Items.Item> GetItemsAroundSecond(Square square)
        {
            var col = square.col;
            var row = square.row;
            var itemsList = new List<Items.Item>();
        ...
        private List<Items.Item> GetItemsAroundThird(Square square)
        {
            var col = square.col;
            var row = square.row;
            var itemsList = new List<Items.Item>();
